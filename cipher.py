...
while next and data.status_code == 200:
    ...
    if (cipher == 'nothing'):
        ...
        # find the last space so we can get the amount by which to rotate
        subIns = cipher.rfind(' ')
        ...
        # find the last space so we can get the hex hash
        subIns = cipher.rfind(' ')
        cipherHash = cipher[subIns+1:]
